...
// myJob.on('open_bank_account', (bankName) => {
//     console.log('Please start process to open bank account in ', bankName);
// });

// myJob.emit('internship_started');
